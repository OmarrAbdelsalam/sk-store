...
export default function Loading() {
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Skeleton - smaller on mobile */}
      <div className="relative h-[40vh] md:h-[60vh] bg-muted animate-pulse">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center space-y-3 md:space-y-4 px-4 w-full">
            ...
            <Skeleton className="h-4 md:h-6 w-64 md:w-96 mx-auto" />
            <Skeleton className="h-10 md:h-12 w-32 md:w-40 mx-auto mt-4 md:mt-6" />
          </div>
        </div>
      </div>
      ...
      <section className="py-4 md:py-12 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="text-start md:text-center md:mb-12 mb-6">
            ...
            <Skeleton className="h-3 md:h-4 w-48 md:w-96 md:mx-auto mb-4" />
