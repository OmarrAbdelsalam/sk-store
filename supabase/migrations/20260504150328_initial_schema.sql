...
CREATE TABLE IF NOT EXISTS quick_promotions (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  promo_type TEXT NOT NULL CHECK(promo_type IN ('buy_x_get_y_free','buy_x_get_y_discount','free_shipping_min_amount','free_shipping_min_items','percentage_off_min_amount','fixed_discount_min_amount','bundle_discount','first_order_discount','free_gift_min_amount')),
  name_en TEXT NOT NULL,
  name_ar TEXT NOT NULL,
  description_en TEXT,
  description_ar TEXT,
